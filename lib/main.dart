...
import 'package:bmi/second%20page.dart';
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                ...
                ElevatedButton(style: ButtonStyle(backgroundColor:MaterialStatePropertyAll(Colors.deepPurple.shade100)),
                    onPressed: () {
                ...
                Text(result,style: t25(rang: Colors.purple),),
